              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <div class="row">
                    ...
                    Puc no: '.$data["p_id"].' - Owner Name:  '.$data["user_name"].'<br> Vehicle No: '.$data["puc_vehicle_no"].'
                  </h4>';
                 ...
                 echo'
                  <div class="border-top pt-3">
                    <div class="d-flex justify-content-between">
                      ...
                      <a href="view_puc_user.php?user_id='.$data["user_id"].'" class="btn btn-primary btn-icon-text">
                        View Details
