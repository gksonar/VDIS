...
if(isset($_POST['Login']))
{
    ...
    $query = 'select * from checker_info where c_password="'.$_POST['password'].'"';
...
if(strlen($_POST['newpassword']) >= 5 )
    {
        ...
        {
        $query1='update checker_info set c_password="'.$_POST['newpassword'].'" where c_email ="'.$_POST['c_email'].'"';    
        ...
        echo 'window.location.href = "checker_change_password.php";'; 
        echo '</script>';
        }
    }
else 
