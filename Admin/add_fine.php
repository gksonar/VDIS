        ...
        <div class="content-wrapper">
          ...
          <div class="row">
            ...
            <div class="col-12 grid-margin" style="margin-left: 20%;    max-width: 60%;">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Add Fine</h4>
                  <form class="form-sample" id="" method="POST" action="">
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="text" id="" name="fine_type" class="form-control" />
                          </div>
                        </div>
                      </div>
                       ...
                       <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="Number" id="" name="fine_charge" class="form-control" />
                          </div>
                        </div>
                      </div>
                    ...
                    <button type="submit" name="submit" class="btn btn-primary mr-2">Add Fine</button>
...
{
  extract($_POST);
  $query="INSERT INTO `fine_user`(`fine_name`,`fine_charge`) VALUES ('$fine_type','$fine_charge')";
  $asd = mysqli_query($con,$query)or die(mysqli_error($con));

  if($asd)
  {
    echo '<script type="text/javascript">';
    echo " alert('Fine Added Successfully');";
  ...
  { 
    echo '<script type="text/javascript">';
    echo " alert('ERROR......Fine Not Added');";
